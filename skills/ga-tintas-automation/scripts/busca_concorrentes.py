...
CONCORRENTES_BASE = [
    ...
    {
        "razao_social": "OBRAMAX ATACADO S.A.",
        "nome_fantasia": "Obramax",
        "cnpj": "N/D",
        "endereco": "Diversas lojas em São Paulo – SP e outras capitais",
        "cnae": "47.44-0/99 - Comércio varejista de materiais de construção em geral",
        "porte": "Grande",
        "capital_social": "N/D",
        "segmento": "Atacado e varejo de materiais de construção com ampla linha de tintas (Suvinil, Coral, etc.)",
        "marcas_trabalhadas": "Suvinil, Coral, e outras (75+ produtos Suvinil disponíveis)",
        "tipo": "CONCORRENTE DIRETO (Home center atacado)",
        "fonte": "obramax.com.br",
    },
    {
        "razao_social": "COFEMA ATACADISTA LTDA",
        "nome_fantasia": "Cofema Atacadista",
        "cnpj": "69.194.454/0001-47",
        "endereco": "Av. Aricanduva, 3241 – Vila Aricanduva, São Paulo – SP, CEP 03.527-000",
        "cnae": "46.72-9/00 - Comércio atacadista de ferragens e ferramentas",
        "porte": "Grande",
        "capital_social": "R$ 18.860.000,00",
        "segmento": "Atacadista de ferragens, ferramentas, tintas e materiais de construção — filiais em Sumaré, Bauru, Ribeirão Preto e Araçatuba",
        "marcas_trabalhadas": "Diversas marcas de tintas e materiais de construção",
        "tipo": "CONCORRENTE DIRETO (Atacadista materiais de construção)",
        "fonte": "cofema.com.br / Receita Federal",
    },
    {
        "razao_social": "ELETROLESTE DISTRIBUIDORA LTDA",
        "nome_fantasia": "Eletroleste",
        "cnpj": "N/D",
        "endereco": "Av. Aricanduva, 5555 – São Paulo – SP",
        "cnae": "46.72-9/00 - Comércio atacadista de ferragens e ferramentas",
        "porte": "Médio",
        "capital_social": "N/D",
        "segmento": "Atacadista de materiais hidráulicos, elétricos, ferramentas, tintas e máquinas",
        "marcas_trabalhadas": "Diversas marcas de tintas e materiais de construção",
        "tipo": "CONCORRENTE DIRETO (Atacadista regional)",
        "fonte": "eletroleste.com.br",
    },
    {
        "razao_social": "RA MARTINS BORGES & NEGÓCIOS LTDA",
        "nome_fantasia": "Ismafer",
        "cnpj": "08.492.961/0004-15",
        "endereco": "São Paulo – SP",
        "cnae": "47.44-0/01 - Comércio varejista de ferragens e ferramentas",
        "porte": "Médio",
        "capital_social": "R$ 1.000.000,00",
        "segmento": "Comércio varejista de ferragens, ferramentas, tintas e materiais de construção",
        "marcas_trabalhadas": "Diversas marcas de ferramentas e tintas",
        "tipo": "CONCORRENTE DIRETO (Varejo especializado)",
        "fonte": "Receita Federal / Econodata",
    },
]
